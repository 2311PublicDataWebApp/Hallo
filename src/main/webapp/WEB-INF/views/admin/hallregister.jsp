							...
							<h5 class="card-title">공연장 등록</h5>
								<form action="/admin/hallregister.do" method="post" enctype="multipart/form-data" name="adm_form" onSubmit="return Checkform()">
					                <div class="row mb-3">
					                  ...
					                  <div class="col-sm-4">
					                    <input type="text" class="form-control" name="hallSpaceName">
					                  </div>
					                </div>
					                <div class="row mb-3">
					                  <label for="inputText" class="col-sm-2 col-form-label">주소 ＊</label>
					                  <div class="col-sm-5">
										<input type="text"  id="member_roadAddress" class="form-control" name="hallAddress">
					                  ...
					                  <div class="col-sm-2">
					                    <p><input type="number" class="form-control" name="hallPeople"> </p>
					                  </div>
					                  </div>
					                   <div class="row mb-3">
					                  <label for="inputText" class="col-sm-2 col-form-label">시간 당 비용</label>
					                  <div class="col-sm-2">
					                    <p><input type="number" class="form-control" name="hallFee"></p>
					                  </div>
					                  </div>
					                 <div class="row mb-3">
					                  <label for="inputText" class="col-sm-2 col-form-label">주의사항</label>
					                  <div class="col-sm-5">
					                   <textarea class="form-control" rows="10" cols="51" name="hallCautions"></textarea>
					                  </div>
					                  </div>
									<div class="row mb-3">
					                ...
					                <div class="row mb-3">
					                 ...
					                 <div class="row mb-3">
					                  <label for="inputText" class="col-sm-2 col-form-label">환불규정</label>
						                  <div class="col-sm-5">
						                    <textarea class="form-control" rows="10" cols="51" name="hallRefunds"></textarea>
						                 </div>
						            </div>
					                 <div class="row mb-3">
					                  <label for="inputText" class="col-sm-2 col-form-label">담당자명 ＊</label>
						                  <div class="col-sm-3">
						                     <input type="text" class="form-control" name="hallAgentName">
						                 </div>
						             </div>
					                 <div class="row mb-3">
									...
									<div class="d-flex col-md-12 justify-content-end">
								            ...
								            <button type="button" class="btn" style="background-color: #FAFAFA; border-color: #e9ecef;" onclick="showhallList();">목록</button>
									</div>
              					</form>
						</div>
					</div>
